$(document).ready(function () {
    ...
    $('#addStaffForm').on("submit", function (event) {
        ...
        var label_confirmed_case_coronavirus = $('.label_confirmed_case_coronavirus');
        ...
        if (affected_countries_last.val() == '') {
            ...
            addError(label_affected_countries_last, affected_countries_last, ErrorMsg);
            error = true;
            return false;
        } else {
            error = false;
        ...
        if (confirmed_case_coronavirus.val() == '') {
            ...
            addError(label_confirmed_case_coronavirus, confirmed_case_coronavirus, ErrorMsg);
            error = true;
            return false;
        } else {
            error = false;
...
function loadStaffTable() {
    $.ajax({
        type: "POST",
        url: "./inc/self-assessment-data/self-assessment-data-show.php",
        beforeSend: function () {
            instanceLoading.showLoading({
                type: 'cube_flip',
                color: '#ffffff',
