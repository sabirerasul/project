                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" class='avatar'><embed width="100%" src='<?= $emp_frontproof ?>' class='img-responsive'></embed></td>
                                        </tr>
                                        <tr>
                                            <th>Back ID Proof</th>
                                            <td colspan="3" class='avatar'><embed width="100%" src='<?= $emp_backproof ?>' class='img-responsive'></embed></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 mx-auto my-3">
                            <a href="service-provider.php" class="btn btn-success mx-auto d-block">Back</a>
                        </div>
                    </div>
