...
foreach ($dateArray as $key => $val) {
    ...
    $model = fetch_all($db, "SELECT * FROM `service_provider_commission_history` WHERE date='{$val}'");

    if (count($model) > 0) {
        foreach ($model as $billingKey1 => $billingVal1) {
            $billingValue1 = (object) $billingVal1;

            if ($service_provider_id != 0) {
                if ($billingValue1->service_provider_id != $service_provider_id) {
                    continue;
                }
            }

            $mainModel[] = $billingValue1;
        }
    }
}
...
<body id="page-top">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                <h6 class="m-0 font-weight-bold text-primary">Service Provider Report</h6>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="form-group">
                                                    <label>&nbsp;</label>
                                                    <a href="service-provider-report.php" class="btn btn-danger d-block"><i class="fa fa-times" aria-hidden="true"></i> Clear</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody class="table-data">
                                        ...
                                        foreach ($mainModel as $modelKey => $modelVal) {
                                            ...
                                            $serviceProviderModel  = fetch_object($db, "SELECT * FROM service_provider WHERE id='{$modelValue->service_provider_id}'");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $serviceProviderModel->contact_number ?></td>
    ...
    <script type="text/javascript" src="./js/pages/service-provider-report.js"></script>
