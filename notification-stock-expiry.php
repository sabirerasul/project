...
<head>
    ...
    <title>Stock Notification - <?= SALONNAME ?></title>
                        ...
                        <div class="col-12 bg-white my-3">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Stock Expiry (6 Month)</h6>
                                </div>
                                            ...
                                            <tbody class="active-table-data">
                                                ...
                                                if (count($modal) > 0) {
                                                    ...
                                                    foreach ($modal as $key => $val) {
                                                        ...
                                                        if (getDateServerFormat($val['exp_date']) >= $endDate) {
                                                            continue;
                                                        }
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-danger"><?= $value->exp_date ?></td>
                                                        </tr>
                                                <?php
                                                        $count++;
                                                    }
