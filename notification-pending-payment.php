                        ...
                        <div class="col-12 bg-white my-3">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Pending Payment</h6>
                                </div>
                                            ...
                                            <tbody class="active-table-data">
                                                ...
                                                if (count($clientModel) > 0) {
                                                    ...
                                                    foreach ($clientModel as $key => $val) {
                                                        ...
                                                        $pendingPayment = get_client_pending_amount($db, $value->id);
                                                        ...
                                                        $approveBtn = "<a class='btn btn-sm btn-danger text-nowrap m-1' onclick='client_check_pending_payment({$value->id})'><i class='fas fa-money-bill'></i> Pay now </a>";
                                                ?>
                                                        <tr>
                                                            <td><?= $count ?></td>
