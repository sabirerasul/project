...
$membershipText = ($id != 0) ? 'Edit' : 'Add';

$model = ($id != 0) ? fetch_object($db, "SELECT * FROM membership WHERE id='" . $id . "'") : new Membership();
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-4">
                            <h2 class="h2 text-gray-800 border shadow rounded d-block p-2"><?= $membershipText ?> Membership</h2>
                        </div>

                        <?php include('./form/membership-form.php') ?>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Manage Membership</h6>
                            <div>
    ...
    <script type="text/javascript" src="./js/pages/membership.js"></script>
