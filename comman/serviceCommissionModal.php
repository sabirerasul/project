<!-- Modal -->
<div class="modal modal-lg fade" id="serviceCommisionM" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Advance Service Commission Setting %</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="./inc/service-provider/commission-save.php" method="post" id="saveCommission1" name="serviceCommission">
        <div class="modal-body">
          <?php include('./form/advance-service-commission-form.php') ?>
          <div class="notes">
