...
if ($id != 0) {
    ...
    if (count($productModel) == 0) {
        $productModel = (array) new PackageService();
...
<head>
    ...
    <title>Packages - <?= SALONNAME ?></title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 mb-4">
                            <h2 class="h2 text-gray-800 border shadow rounded d-block p-2"><?= $packageText ?> Package</h2>
                        </div>
                        ...
                        <?php include('./form/package-form.php') ?>
                    </div>
                    <div class="row">
