...
<head>
    ...
    <title>SMS Panel - <?= SALONNAME ?></title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                                ...
                                <div class="card-body shadow rounded p-2">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th><input type='checkbox' id='enqchk' value="0"></th>
                                                    <th>#</th>
                                                    <th>Name</th>
                                                    <th>Contact</th>
                                                    <th>Branch</th>
                                            ...
                                            <tbody class="active-table-data">
                                                ...
                                                foreach ($clientModel as $clientKey => $clientVal) {
                                                    ...
                                                    $branchModel = fetch_object($db, "SELECT * FROM branch WHERE id='{$clientValue->branch_id}'");
                                                ?>
                                                    <tr>
                                                        <td><input type='checkbox' class='chkk' value='<?= $clientValue->id ?>'></td>
                                                        <td><?= $count ?></td>
                        ...
                        <div class="col-md-12 bg-white my-3 mx-auto text-center">
                            <button class="btn btn-lg d-block btn-success mx-auto" onclick="triggerSMSModal()">Send SMS</button>
                        </div>
                    </div>
                </div>
