...
<head>
    ...
    <title>Service Import/Export - <?= SALONNAME ?></title>
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12 mb-2">
                            <h2 class="h2 text-gray-800 border shadow rounded d-block p-2">Service Export</h2>
                        </div>
                        <div class="col-md-12 my-3">
                            <button class="btn btn-success" onclick="serviceExport()"> <i class="fas fa-file-export"></i> Export</button>
                        </div>
                        <hr>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 mb-2">
                            <h2 class="h2 text-gray-800 border shadow rounded d-block p-2">Service Import</h2>
                        </div>
                        <div class="col-md-12 my-3">
                            <button class="btn btn-success" onclick="serviceSample()"> <i class="fas fa-download"></i> Download Sample</button>
                        ...
                        <div class="col-md-12" id="importFrm" style="display: none;">
                            ...
                            <form action="./inc/service/service-import-save.php" id="excel_form" method="post" enctype="multipart/form-data">
    ...
    <script type="text/javascript" src="./js/pages/service-import-export.js"></script>
