                        ...
                        <div class="col-12 bg-white my-3">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex justify-content-between">
                                    ...
                                    <p class="text-bold text-success"><?= "Wallet Balance INR " . get_client_wallet($db, $id) ?></p>
                                </div>
                                            ...
                                            <tbody class="active-table-data">
                                                ...
                                                if (count($walletModel) > 0) {
                                                    ...
                                                    foreach ($walletModel as $walletKey => $walletVal) {
                                                        ...
                                                        $transaction_type = ($walletValue->transaction_type == 'Credit') ? "<span class='text-success'>{$walletValue->transaction_type}</span>" : "<span class='text-danger'>{$walletValue->transaction_type}</span>";
                                                        $payment_mode = (!empty($walletValue->payment_method)) ? $appointmentPaymentModeArr[$walletValue->payment_method] : '--';
                                                ?>
                                                        <tr>
                                                            <td><?= $count ?></td>
