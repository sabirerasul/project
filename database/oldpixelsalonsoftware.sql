...
(66, 4, 56, 0, '28/03/2023', '03:15 PM', 'on call', '', 900, 0, 'percentage', NULL, 900, '900', NULL, 'Pending', 1, '2023-03-28 13:06:54', NULL, NULL, NULL);
...
(95, 66, 3, 48, '0', 'percentage', '03:15 PM', '03:30 PM', '2023-03-28 15:15:00', '2023-03-28 15:30:00', 900);
...
(4, 3, 'Branch 1', 'Lakme', 'Alambagh Lko', '9999999999', 'itsabirerasul@gmail.com', 'abc.com', 'dfdfdfdfdfdfd', '08:00 AM', '11:55 PM', '24433039final-logo.png', '2023-01-02 00:45:06', NULL, '2023-03-18 16:41:45', NULL),
...
--
-- Dumping data for table `branch_sms_history`
--

INSERT INTO `branch_sms_history` (`id`, `client_id`, `message_id`, `schedule`, `created_at`, `updated_at`) VALUES
(7, 44, 5, '16/03/2023 06:30 PM', '2023-03-16 18:38:05', NULL),
(8, 56, 6, '', '2023-03-16 18:43:27', NULL),
(9, 56, 6, '', '2023-03-16 18:44:48', NULL),
(10, 56, 6, '2023/03/17 10:30:00 AM', '2023-03-17 10:27:52', NULL),
(12, 56, 6, '2023/03/17 10:30:00 AM', '2023-03-17 10:29:04', NULL),
(14, 56, 6, '2023/03/17 10:40:00 AM', '2023-03-17 10:34:49', NULL),
(16, 56, 6, '2023/03/17 11:30:00 AM', '2023-03-17 11:23:46', NULL);
...
INSERT INTO `client_billing` (`id`, `branch_id`, `client_id`, `appointment_id`, `membership_id`, `invoice_number`, `billing_date`, `billing_time`, `service_for`, `sub_total`, `coupon_code`, `discount`, `discount_type`, `tax`, `total`, `referral_code`, `give_reward_point`, `advance_receive`, `pending_amount`, `status`, `notes`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(149, 4, 56, 0, 0, 'LA2303165606', '28/03/2023', '04:55 PM', '', '20500.00', '', '0.00', 'percentage', '', '20500.00', '', 1, '0.00', '0.00', '1', '', '2023-03-28 16:56:06', NULL, NULL, NULL);
...
--
-- Dumping data for table `client_billing_assign_service_provider`
--

INSERT INTO `client_billing_assign_service_provider` (`id`, `billing_id`, `billing_service_id`, `service_provider_id`) VALUES
(213, 149, 229, 1),
(214, 149, 230, 1);
...
--
-- Dumping data for table `client_billing_payment`
--

INSERT INTO `client_billing_payment` (`id`, `billing_id`, `transaction_id`, `advance`, `method`) VALUES
(157, 149, '', '20500.00', '1');
...
--
-- Dumping data for table `client_billing_product`
--

INSERT INTO `client_billing_product` (`id`, `billing_id`, `service_cat_id`, `service_id`, `service_type`, `quantity`, `service_discount`, `service_discount_type`, `start_time`, `end_time`, `start_timestamp`, `end_timestamp`, `price`) VALUES
(229, 149, 0, 1, 'package', 1, '0', 'percentage', '04:55 PM', '04:55 PM', '2023-03-28 16:55:00', '2023-03-28 16:55:00', 500),
(230, 149, 0, 2, 'membership', 1, '0', 'percentage', '04:55 PM', '04:55 PM', '2023-03-28 16:55:00', '2023-03-28 16:55:00', 20000);
...
INSERT INTO `client_membership` (`id`, `client_id`, `membership_id`, `billing_id`, `valid_upto`, `created_at`, `updated_at`) VALUES
(8, 56, 2, 149, '27-05-2023', '2023-03-28 16:56:06', NULL);
...
INSERT INTO `client_package` (`id`, `client_id`, `package_id`, `billing_id`, `valid_upto`, `created_at`, `updated_at`) VALUES
(9, 56, 1, 149, '27-04-2023', '2023-03-28 16:56:06', NULL);
...
--
-- Dumping data for table `client_package_details`
--

INSERT INTO `client_package_details` (`id`, `client_id`, `client_package_id`, `service_id`, `quantity`, `price`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(17, 56, 9, 26, 1, '1200.00', '2023-03-28 16:56:06', NULL, NULL, NULL);
...
--
-- Dumping data for table `client_referral_code`
--

INSERT INTO `client_referral_code` (`id`, `client_id`, `referral_code`, `created_at`) VALUES
(3, 59, 'RAJE230359', '2023-03-21 17:51:24'),
(4, 56, 'SABI230356', '2023-03-21 17:51:25');
...
(1, 'save20', 100, 'inr', '500.00', '100.00', 2, '24/03/2023', 50, '2023-03-23 16:32:45', NULL, NULL, NULL),
(2, 'save50', 50, 'percentage', '1000.00', '400.00', 2, '24/03/2023', 100, '2023-03-23 16:33:54', NULL, NULL, NULL);
...
(213, '2023-03-28', 4, 56, 66, NULL, 4, '900.00', '0.00', '0.00', '900.00', NULL, 'appointment', '2023-03-28 13:06:54', NULL, NULL, NULL),
(214, '28/03/2023', 4, 56, 149, 0, 4, '20500.00', '0.00', '20500.00', '0.00', NULL, 'bill', '2023-03-28 16:56:06', NULL, NULL, NULL);
...
INSERT INTO `reward_point` (`id`, `client_id`, `branch_id`, `date`, `app_bill_id`, `type`, `points`, `transaction_type`, `created_at`) VALUES
(118, 56, 4, '28/03/2023', 149, 'billing', '200', 'Credit', '2023-03-28 16:56:06');
...
--
-- Dumping data for table `service_provider_commission_history`
--

INSERT INTO `service_provider_commission_history` (`id`, `service_provider_id`, `billing_id`, `date`, `price`, `service_id`, `service_type`, `commission`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(163, 1, 149, '28/03/2023', '500.00', 1, 'package', '50.00', '2023-03-28 16:56:06', NULL, NULL, NULL);
