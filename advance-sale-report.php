...
<head>
    <title>Advance Sale Report- <?= SALONNAME ?></title>
...
<body id="page-top">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="form-group">
                                                    <label>&nbsp;</label>
                                                    <a href="advance-sale-report.php" class="btn btn-danger d-block"><i class="fa fa-times" aria-hidden="true"></i> Clear</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript" src="./js/pages/advance-sale-report.js"></script>
