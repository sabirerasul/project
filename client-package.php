                                            ...
                                            <tbody class="active-table-data">
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $totalService ?></td>
                                                            <td><?= $availQuantity ?></td>
                                                            <td><a target="_blank" href='./client-package-view.php?id=<?= $id ?>&pkg_id=<?= $packageValue->id ?>' class='btn btn-primary btn-sm btn-block text-nowrap' type='button'> <i class='fas fa-view' aria-hidden='true'></i> View</a></td>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            </tbody>
